...
export default async function Visitors(){const donations=await getDonationSettings();return <PageShell><InnerHero kicker="Visitor guide · All aboard" title={<>Plan a day<br/><em>off the main line.</em></>} copy="Everything you need for a safe, easy and memorable day at York Model Engineers." image="/images/entrance.webp" imageAlt="The entrance to York Model Engineers in Dringhouses"/>
