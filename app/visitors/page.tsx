import { AlertTriangle, Camera, Car, CheckCircle2, Gauge, MapPin, ShieldCheck } from "lucide-react";
...
<section className="cta-strip"><h2>Ready to make tracks?</h2><Link className="button brass" href="/events">Find an open day</Link></section></PageShell>}
