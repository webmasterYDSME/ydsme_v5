...
export default async function DonationsPage({ searchParams }: { searchParams: Promise<Query> }) {
  ...
  return <div className="portal-content"><header className="portal-heading"><div><p className="eyebrow dark">Administrator only</p><h1>Donations</h1><p>Reconcile verified online payments and refunds across the Society’s active appeals.</p></div><span className="count-badge"><HeartHandshake/>{count ?? 0} matching</span></header>
