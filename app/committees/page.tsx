...
export default async function Committees() {
  ...
  return <PageShell><InnerHero kicker="The people at the points" title={<>Meet the crew<br/><em>behind the railway.</em></>} copy="A volunteer committee bringing expertise, care and commitment to every part of Society life." image="/images/track.webp"/>
