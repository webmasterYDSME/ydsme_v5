...
const messages: Record<string, string> = {
  ...
  "renewals-not-open": "Open renewals for that year before sending invitations.",
  "renewal-test-failed": "The test email could not be sent. Try again.",
  "renewal-reminders-failed": "The reminders could not be sent. Try again.",
  "renewal-link-not-open": "Open renewals for this year first (on the Renewals page), then send the new link.",
  "renewal-link-no-email": "This member has no email address on file, so the link cannot be emailed. Add one first, or contact them another way.",
  "renewal-link-unavailable": "A new renewal link can only be sent to a lapsed member who has not already paid for this year.",
  "renewal-link-failed": "The new renewal link could not be sent. Try again.",
...
const notices: Record<string, string> = {
  ...
  "renewals-opened": "Renewals are open. Nobody has been emailed yet. Send yourself a test, then send the invitations when you are ready.",
  "renewal-invitations-queued": "The invitations are queued. They go out a few at a time, within the daily email limit, so a large club can take a few days.",
  "renewal-invitations-none": "Nobody needed an invitation. Everyone eligible has already been invited.",
  "renewal-link-sent": "A new renewal link has been emailed to the member. It works for 30 days.",
  "renewal-test-sent": "A test email is on its way to your own address.",
  "renewal-reminders-sent": "Reminders are on their way.",
  "renewal-reminders-none": "No reminders were queued. Everyone who is waiting was reminded in the last 7 days, has no email address, or has not been sent their invitation yet.",
