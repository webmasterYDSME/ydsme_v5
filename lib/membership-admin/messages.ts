...
const messages: Record<string, string> = {
  ...
  "payment-details-invalid": "Some payment details are missing or not valid. Check the treasurer details, the account number (8 digits) and the instructions. Nothing was saved.",
